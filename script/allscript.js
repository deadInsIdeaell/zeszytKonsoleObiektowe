     ...
     * Copyright (c) 2019 Dmitry Semenov; */ !(function (a, factory) {
      ...
      var t = function (template, t, items, e) {
        ...
        var u = function () {
          ...
          Ut = function () {
            for (var t in Bt) if (Bt.hasOwnProperty(t)) Nt(t);
          },
          ...
          rn = function (t) {
            ...
            var f = -1;
            if (0 === c)
              if (((ue = false), n.unbind(window, w, i), Ne(), ye)) f = 0;
          ...
          an = function (t) {
            ...
            Ft("zoomPan"), (t.lastNow = ft()), t.panAnimLoop();
          },
          sn = function (t, e) {
            var o, a, u;
            if (!_e) oe = h;
          ...
          publicMethods: {
            initGestures: function () {
              var t = function (t, e, move, n, i) {
                if (((N = t + e), (F = t + move), (U = t + n), i)) z = t + i;
                else z = "";
              };
        ...
        at("History", {
          publicMethods: {
            ...
            onHashChange: function () {
              ...
              if (!Nn) (Fn = true), i.goTo(Gn().pid), (Fn = false);
            },
            updateURL: function () {
              if ((jn(), !Fn))
                if (!zn) Zn();
     ...
     * Copyright (c) 2019 Dmitry Semenov; */ !(function (a, factory) {
      ...
      return function (t, e) {
        var n = this,
          ...
          U = 0,
          z = function () {
            if ((clearTimeout(F), (U = 0), v)) n.setIdle(false);
          },
          H = function (t) {
        ...
        var vt = (a.addEvent = function (t, names, n) {
          ...
          Ct = function () {
            var t = c.clientHeight,
              ...
              n;
            for (e in Ft) {
              if ("function" == typeof (n = Ft[e])) n = n.call(Mt);
...
*/
  ...
  11459: function (t, e, n) {
    "use strict";
    var Animation = n(11460),
      i = n(244);
    n(556), (window.uAnimation = new Animation(i.instance()).init());
  },
    ...
    (t.exports = i),
      ...
      (i.prototype.fillItem = function t(e, product) {
        var title = product.title || "",
          ...
          l = u.attr("class"),
          c = o("<span/>").addClass(l).text(title);
    ...
    (window._npCartInit = function () {
      ...
      if (n.$cart.length)
        s.getModel().load(function (t, data) {
          if (data && data.products) n.init(data.products);
        });
    }),
      i(function () {
        window._npCartInit();
      ...
      i(function () {
        c.handle(function (routes) {
          ...
          i(".u-categories .u-category-link").on("click", function (t) {
            var link = i(this),
              list = a.findNearestProducts(link.closest(".u-categories")).eq(0);
            if (list.length) {
              t.preventDefault();
              var id = list.attr("data-products-id"),
                sorting = s.getActiveSorting(list),
                e = link.attr("data-category") || "";
  ...
  22: function (t, e, n) {
    ...
    }).call(e, n(120), n(328).setImmediate, n(53), n(54).Buffer);
  },
  234: function (t, e, n) {
    "use strict";
    function i() {
  ...
  3233: function (t, e, n) {
    ...
    (i.getModel = function () {
      ...
      (i.prototype.load = function (t) {
        ...
        if (e && /false/.test(e)) return t(null);
        ...
        if (!this._queue) this._queue = fetch(i);
        this._queue
          .then(function (t) {
  ...
  3234: function (t, e, n) {
    ...
    (i.findNearestCategories = function (list) {
      var categories = list
        .closest("body")
        .find(
          '.u-categories[data-products-datasource="site"]:not(.u-categories-listbox)'
        );
  ...
  556: function (t, e, n) {
    "use strict";
    var i = n(244).instance();
    i.registerAnimation(n(557)),
      i.registerAnimation(n(560)),
      i.registerAnimation(n(245));
  },
  557: function (t, e, n) {
    "use strict";
    function i(t, e) {
                ...
                if (this._touchSupported) {
                  ...
                  if (
                    ...
                    s["default"](this._element).on(B, function (t) {
                      ...
                      s["default"](this._element).on(N, function (t) {
                        return i(t);
                      }),
